...
using System;
using Sitecore.XA.Foundation.RenderingVariant.Rules.Action;
...
namespace Sitecore.XA.Foundation.RenderingVariant.Pipeline.CustomizeRendering
{
    public class ResolvePersonalizedRenderingVariant : Personalize
    {
        ...
        {
            if (action.GetType().Name.StartsWith("ApplyRenderingVariantParameterAction"))
            {
                _VariantId = (action as ApplyRenderingVariantParameterAction<ConditionalRenderingsRuleContext>).VariantID;
            }
        }
